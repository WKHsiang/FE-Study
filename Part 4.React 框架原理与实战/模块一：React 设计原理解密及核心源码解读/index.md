...
![Image](images/20210218215052200.gif)

## 三. 组件
### 3.1 什么是组件
React 是基于组件的方式进行用户界面开发的. 组件可以理解为对页面中某一块区域的封装。
![Image](images/20210218215106324.png)
...
![Image](images/20210218215123381.png)
...
### 3.5 类组件生命周期函数
![Image](images/20210218215137324.jpg)
...
![Image](images/20210218215153287.png)
